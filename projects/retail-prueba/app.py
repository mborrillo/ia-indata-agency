"""
SIMIR – Dashboard Profesional Retail (Estilo GesPro claro)
...
# CSS limpio y legible (fondo gris claro como pediste)
st.markdown("""
<style>
    ...
    .stButton>button { width: 100%; border-radius: 8px; height: 48px; font-weight: 500; }
    .stRadio { margin-bottom: 20px; }
</style>
...
with st.sidebar:
    ...
    st.markdown("### 📊 SIMIR Dashboard")
    
    page = st.radio("Selecciona sección:", 
                    ["📈 Resumen", "📊 Comparativa", "📋 Detalle", "📄 Reporte Ejecutivo"],
                    label_visibility="collapsed")

    st.divider()
    st.caption("Conexión segura • Neon DB LIVE")
